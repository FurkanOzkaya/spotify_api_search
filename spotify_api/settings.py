...
from spotify_api.env_parser import env
...
SECRET_KEY = "django-insecure-@tn4=76=_5=@^^l@o=x)w5pt=8sm$_a0hallw(ed!gimt@%e8^"
...
SPOTIFY_TRACK_LIMIT = env.int("TRACK_LIMIT", 50)
